...
//                        System.out.println(body2var.getName() + " has mass of " + body2var.getMass() + "  = " +  body1var.getMass());
                        System.out.println(body1var.getName() + " x " + body1var.getx()+ " y " + body1var.gety()+ " z " + body1var.getz()+ " d3 " + distance3 + " body2mass " + body2var.getMass()+ " -g*... " + -(Constants.g * body2var.getMass() * (body1var.getx() - body2var.getx())) / distance3 + " xv " +  xyz[3])   ;
                        System.out.println(body1var.getName() + " x " + body1var.getx()+ " y " + body1var.gety()+ " z " + body1var.getz()+ " d3 " + distance3 + " body2mass " + body2var.getMass()+ " -g*... " + -(Constants.g * body2var.getMass() * (body1var.gety() - body2var.gety())) / distance3 + " yv " +  xyz[4])   ;
                        System.out.println(body1var.getName() + " x " + body1var.getx()+ " y " + body1var.gety()+ " z " + body1var.getz()+ " d3 " + distance3 + " body2mass " + body2var.getMass()+ " -g*... " + -(Constants.g * body2var.getMass() * (body1var.getz() - body2var.getz())) / distance3 + " zv " +  xyz[5])   ;
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        // Equation 3    G    M                      (     r_x1       -     r_x2        )   / r^3
